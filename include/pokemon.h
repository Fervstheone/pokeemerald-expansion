...
struct BoxPokemon
{
    ...
    u16 minTrainedHP:1;
    u16 minTrainedAttack:1;
    u16 minTrainedSpAttack:1;
    u16 minTrainedSpDefense:1;
    u16 minTrainedDefense:1;
    ...
    u16 coolRibbon:3;     // Stores the highest contest rank achieved in the Cool category.
    ...
    u16 championRibbon:1; // Given when defeating the Champion. Because both RSE and FRLG use it, later generations don't specify from which region it comes from.
