...
$(OBJEVENTGFXDIR)/pokemon/burmy_sand.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
    
$(OBJEVENTGFXDIR)/pokemon/burmy_trash.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
    
$(OBJEVENTGFXDIR)/pokemon/wormadam.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
    
$(OBJEVENTGFXDIR)/pokemon/wormadam_sand.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
    
$(OBJEVENTGFXDIR)/pokemon/wormadam_trash.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
...
$(OBJEVENTGFXDIR)/pokemon/shellos_west.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
    
$(OBJEVENTGFXDIR)/pokemon/shellos_east.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
    
$(OBJEVENTGFXDIR)/pokemon/gastrodon_west.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
    
$(OBJEVENTGFXDIR)/pokemon/gastrodon_east.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
...
$(OBJEVENTGFXDIR)/pokemon/porygonz.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
...
$(OBJEVENTGFXDIR)/pokemon/rotom_base.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
...
$(OBJEVENTGFXDIR)/pokemon/giratina_normal.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 8 -mheight 8
...
$(OBJEVENTGFXDIR)/pokemon/shaymin_land.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
