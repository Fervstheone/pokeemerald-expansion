...
static const u8 sRegisteredL_Gfx[] = INCBIN_U8("graphics/interface/L_button.4bpp");
static const u8 sRegisteredR_Gfx[] = INCBIN_U8("graphics/interface/R_button.4bpp");
