...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM_ROOST] =
    {
        .name = _("TM52"),
        .price= 3000,
        .description = COMPOUND_STRING("The user lands,\n"
                                       "restoring HP by\n"
                                       "half of its max HP."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_DUAL_WINGBEAT] =
    {
        .name = _("TM54"),
        .price= 3000,
        .description = COMPOUND_STRING("Slams the target\n"
                                       "with both wings,\n"
                                       "hitting twice."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_FOCUS_BLAST] =
    {
        .name = _("TM55"),
        .price= 3000,
        .description = COMPOUND_STRING("Heighten senses to\n"
                                       "release max power.\n"
                                       "May lower Sp. Def."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_ENERGY_BALL] =
    {
        .name = _("TM56"),
        .price= 3000,
        .description = COMPOUND_STRING("Draws nature's power\n"
                                       "power to attack.\n"
                                       "May lower Sp. Def."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_SCALD] =
    {
        .name = _("TM58"),
        .price= 3000,
        .description = COMPOUND_STRING("Shoot boiling water\n"
                                       "at the foe.\n"
                                       "May inflict a burn."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_BRAVE_BIRD] =
    {
        .name = _("TM60"),
        .price= 3000,
        .description = COMPOUND_STRING("Tucks the wings\n"
                                       "and charges the foe\n"
                                       "at low altitude."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_EARTH_POWER] =
    {
        .name = _("TM61"),
        .price= 3000,
        .description = COMPOUND_STRING("Erupts the ground\n"
                                       "with enormous power.\n"
                                       "May lower Sp. Def."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_EXPLOSION] =
    {
        .name = _("TM63"),
        .price= 3000,
        .description = COMPOUND_STRING("Explodes to inflict\n"
                                       "heavy damage.\n"
                                       "Faints the user"),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_GYRO_BALL] =
    {
        .name = _("TM71"),
        .price= 3000,
        .description = COMPOUND_STRING("A fast spin that\n"
                                       "does more damage\n"
                                       "to faster foes."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_CURSE] =
    {
        .name = _("TM73"),
        .price= 3000,
        .description = COMPOUND_STRING("A mysterious move.\n"
                                       "Works differently\n"
                                       "for Ghosts."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_BULLDOZE] =
    {
        .name = _("TM74"),
        .price= 3000,
        .description = COMPOUND_STRING("Stomps the ground,\n"
                                       "hitting everything.\n"
                                       "Lowers Speed."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_FROST_BREATH] =
    {
        .name = _("TM75"),
        .price= 3000,
        .description = COMPOUND_STRING("A frosty attack,\n"
                                       "that always results\n"
                                       "in a critical hit."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_ROCK_SLIDE] =
    {
        .name = _("TM76"),
        .price= 3000,
        .description = COMPOUND_STRING("Hurl large boulders\n"
                                       "on the foe.\n"
                                       "May cause flinch"),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_X_SCISSOR] =
    {
        .name = _("TM77"),
        .price= 3000,
        .description = COMPOUND_STRING("Slash the foe with\n"
                                       "crossed scythes,\n"
                                       "claws, etc."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_DRAGON_TAIL] =
    {
        .name = _("TM78"),
        .price= 3000,
        .description = COMPOUND_STRING("Knocks the foe away\n"
                                       "dragging another or\n"
                                       "ending the battle."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_INFESTATION] =
    {
        .name = _("TM79"),
        .price= 3000,
        .description = COMPOUND_STRING("Infest the foe,\n"
                                       "causing damage\n"
                                       "for 4 or 5 turns."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_POISON_JAB] =
    {
        .name = _("TM80"),
        .price= 3000,
        .description = COMPOUND_STRING("A precise stabbing\n"
                                       "attack that\n"
                                       "may poison the foe."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_DREAM_EATER] =
    {
        .name = _("TM81"),
        .price= 3000,
        .description = COMPOUND_STRING("Recover half the\n"
                                       "damage inflicted\n"
                                       "on a sleeping foe."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_LOW_SWEEP] =
    {
        .name = _("TM83"),
        .price= 3000,
        .description = COMPOUND_STRING("Attack the legs,\n"
                                       "reducing the\n"
                                       "target's Speed."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_TRICK_ROOM] =
    {
        .name = _("TM88"),
        .price= 3000,
        .description = COMPOUND_STRING("Shift dimensions,\n"
                                       "making slower\n"
                                       "Pokémon move first."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_POWER_UP_PUNCH] =
    {
        .name = _("TM91"),
        .price= 3000,
        .description = COMPOUND_STRING("A hard punch\n"
                                       "that raises\n"
                                       "the user's Attack."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_DAZZLING_GLEAM] =
    {
        .name = _("TM92"),
        .price= 3000,
        .description = COMPOUND_STRING("Damages foes\n"
                                       "by emitting\n"
                                       "a bright flash."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_RAPID_SPIN] =
    {
        .name = _("TM93"),
        .price= 3000,
        .description = COMPOUND_STRING("Spins the body\n"
                                       "at high speeds\n"
                                       "striking the foe."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_SLUDGE_WAVE] =
    {
        .name = _("TM95"),
        .price= 3000,
        .description = COMPOUND_STRING("Swamps the foe with\n"
                                       "a wave of sludge.\n"
                                       "May also poison."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_THUNDER_PUNCH] =
    {
        .name = _("TM98"),
        .price= 3000,
        .description = COMPOUND_STRING("An electric punch\n"
                                       "that may paralyze\n"
                                       "the foe."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_ICE_PUNCH] =
    {
        .name = _("TM99"),
        .price= 3000,
        .description = COMPOUND_STRING("An icy punch\n"
                                       "that may freeze\n"
                                       "the foe."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
