...
enum 
{
    PAL_TAG_SQUIRTLE_SURF = SURFMON_PAL_TAG+1,
...
enum 
{
    PAL_SHINY_TAG_SQUIRTLE_SURF = SURFMON_SHINY_TAG+1,
    PAL_SHINY_TAG_WARTORTLE_SURF,
    PAL_SHINY_TAG_BLASTOISE_SURF,
    PAL_SHINY_TAG_PIKACHU_SURF,
    PAL_SHINY_TAG_RAICHU_SURF,
    PAL_SHINY_TAG_NIDOQUEEN_SURF,
    PAL_SHINY_TAG_NIDOKING_SURF,
    PAL_SHINY_TAG_PSYDUCK_SURF,
    PAL_SHINY_TAG_GOLDUCK_SURF,
    PAL_SHINY_TAG_POLIWAG_SURF,
    PAL_SHINY_TAG_POLIWHIRL_SURF,
    PAL_SHINY_TAG_POLIWRATH_SURF,
    PAL_SHINY_TAG_TENTACOOL_SURF,
    PAL_SHINY_TAG_TENTACRUEL_SURF,
    PAL_SHINY_TAG_SLOWPOKE_SURF,
    PAL_SHINY_TAG_SLOWBRO_SURF,
    PAL_SHINY_TAG_SEEL_SURF,
    PAL_SHINY_TAG_DEWGONG_SURF,
    PAL_SHINY_TAG_SHELLDER_SURF,
    PAL_SHINY_TAG_CLOYSTER_SURF,
    PAL_SHINY_TAG_KRABBY_SURF,
    PAL_SHINY_TAG_KINGLER_SURF,
    PAL_SHINY_TAG_LICKTUNG_SURF,
    PAL_SHINY_TAG_RHYDON_SURF,
    PAL_SHINY_TAG_KANGASKHAN_SURF,
    PAL_SHINY_TAG_HORSEA_SURF,
    PAL_SHINY_TAG_SEADRA_SURF,
    PAL_SHINY_TAG_GOLDEEN_SURF,
    PAL_SHINY_TAG_SEAKING_SURF,
    PAL_SHINY_TAG_STARYU_SURF,
    PAL_SHINY_TAG_STARMIE_SURF,
    PAL_SHINY_TAG_TAUROS_SURF,
    PAL_SHINY_TAG_GYARADOS_SURF,
    PAL_SHINY_TAG_LAPRAS_SURF,
    PAL_SHINY_TAG_VAPOREON_SURF,
    PAL_SHINY_TAG_OMANYTE_SURF,
    PAL_SHINY_TAG_OMASTAR_SURF,
    PAL_SHINY_TAG_KABUTO_SURF,
    PAL_SHINY_TAG_KABUTOPS_SURF,
    PAL_SHINY_TAG_SNORLAX_SURF,
    PAL_SHINY_TAG_DRATINI_SURF,
    PAL_SHINY_TAG_DRAGONAIR_SURF,
    PAL_SHINY_TAG_DRAGONITE_SURF,
    PAL_SHINY_TAG_MEW_SURF,
// Gen II Pokemon
    PAL_SHINY_TAG_TOTODILE_SURF,
    PAL_SHINY_TAG_CROCONAW_SURF,
    PAL_SHINY_TAG_FERALIGATR_SURF,
    PAL_SHINY_TAG_SENTRET_SURF,
    PAL_SHINY_TAG_FURRET_SURF,
    PAL_SHINY_TAG_CHINCHOU_SURF,
    PAL_SHINY_TAG_LANTURN_SURF,
    PAL_SHINY_TAG_PICHU_SURF,
    PAL_SHINY_TAG_MARILL_SURF,
    PAL_SHINY_TAG_AZUMARILL_SURF,
    PAL_SHINY_TAG_POLITOED_SURF,
    PAL_SHINY_TAG_WOOPER_SURF,
    PAL_SHINY_TAG_QUAGSIRE_SURF,
    PAL_SHINY_TAG_SLOWKING_SURF,
    PAL_SHINY_TAG_QWILFISH_SURF,
    PAL_SHINY_TAG_SNEASEL_SURF,
    PAL_SHINY_TAG_CORSOLA_SURF,
    PAL_SHINY_TAG_REMORAID_SURF,
    PAL_SHINY_TAG_OCTILLERY_SURF,
    PAL_SHINY_TAG_MANTINE_SURF,
    PAL_SHINY_TAG_KINGDRA_SURF,
    PAL_SHINY_TAG_MILTANK_SURF,
    PAL_SHINY_TAG_SUICUNE_SURF,
    PAL_SHINY_TAG_TYRANITAR_SURF,
    PAL_SHINY_TAG_LUGIA_SURF,
// Gen III Pokemon
    PAL_SHINY_TAG_MUDKIP_SURF,
    PAL_SHINY_TAG_MARSHTOMP_SURF,
    PAL_SHINY_TAG_SWAMPERT_SURF,
    PAL_SHINY_TAG_ZIGZAGOON_SURF,
    PAL_SHINY_TAG_LINOONE_SURF,
    PAL_SHINY_TAG_LOTAD_SURF,
    PAL_SHINY_TAG_LOMBRE_SURF,
    PAL_SHINY_TAG_LUDICOLO_SURF,
    PAL_SHINY_TAG_PELIPPER_SURF,
    PAL_SHINY_TAG_EXPLOUD_SURF,
    PAL_SHINY_TAG_MAKUHITA_SURF,
    PAL_SHINY_TAG_HARIYAMA_SURF,
    PAL_SHINY_TAG_AZURILL_SURF,
    PAL_SHINY_TAG_AGGRON_SURF,
    PAL_SHINY_TAG_CARVANHA_SURF,
    PAL_SHINY_TAG_SHARPEDO_SURF,
    PAL_SHINY_TAG_WAILMER_SURF,
    PAL_SHINY_TAG_WAILORD_SURF,
    PAL_SHINY_TAG_BARBOACH_SURF,
    PAL_SHINY_TAG_WHISCASH_SURF,
    PAL_SHINY_TAG_CORPHISH_SURF,
    PAL_SHINY_TAG_CRAWDAUNT_SURF,
    PAL_SHINY_TAG_FEEBAS_SURF,
    PAL_SHINY_TAG_MILOTIC_SURF,
    PAL_SHINY_TAG_SPHEAL_SURF,
    PAL_SHINY_TAG_SEALEO_SURF,
    PAL_SHINY_TAG_WALREIN_SURF,
    PAL_SHINY_TAG_CLAMPERL_SURF,
    PAL_SHINY_TAG_HUNTAIL_SURF,
    PAL_SHINY_TAG_GOREBYSS_SURF,
    PAL_SHINY_TAG_RELICANTH_SURF,
    PAL_SHINY_TAG_LUVDISC_SURF,
    PAL_SHINY_TAG_LATIAS_SURF,
    PAL_SHINY_TAG_LATIOS_SURF,
    PAL_SHINY_TAG_KYOGRE_SURF,
    PAL_SHINY_TAG_RAYQUAZA_SURF,
};

const struct CompressedSpritePalette sSurfablePokemonPalettes[] = {
...
const struct CompressedSpritePalette sSurfablePokemonShinyPalettes[] = {
    {gSurfablePokemonShinyPalette_Squirtle,   PAL_SHINY_TAG_SQUIRTLE_SURF},
    {gSurfablePokemonShinyPalette_Wartortle,  PAL_SHINY_TAG_WARTORTLE_SURF},
    {gSurfablePokemonShinyPalette_Blastoise,  PAL_SHINY_TAG_BLASTOISE_SURF},
    {gSurfablePokemonShinyPalette_Pikachu,    PAL_SHINY_TAG_PIKACHU_SURF},
    {gSurfablePokemonShinyPalette_Raichu,     PAL_SHINY_TAG_RAICHU_SURF},
    {gSurfablePokemonShinyPalette_Nidoqueen,  PAL_SHINY_TAG_NIDOQUEEN_SURF},
    {gSurfablePokemonShinyPalette_Nidoking,   PAL_SHINY_TAG_NIDOKING_SURF},
    {gSurfablePokemonShinyPalette_Psyduck,    PAL_SHINY_TAG_PSYDUCK_SURF},
    {gSurfablePokemonShinyPalette_Golduck,    PAL_SHINY_TAG_GOLDUCK_SURF},
    {gSurfablePokemonShinyPalette_Poliwag,    PAL_SHINY_TAG_POLIWAG_SURF},
    {gSurfablePokemonShinyPalette_Poliwhirl,  PAL_SHINY_TAG_POLIWHIRL_SURF},
    {gSurfablePokemonShinyPalette_Poliwrath,  PAL_SHINY_TAG_POLIWRATH_SURF},
    {gSurfablePokemonShinyPalette_Tentacool,  PAL_SHINY_TAG_TENTACOOL_SURF},
    {gSurfablePokemonShinyPalette_Tentacruel, PAL_SHINY_TAG_TENTACRUEL_SURF},
    {gSurfablePokemonShinyPalette_Slowpoke,   PAL_SHINY_TAG_SLOWPOKE_SURF},
    {gSurfablePokemonShinyPalette_Slowbro,    PAL_SHINY_TAG_SLOWBRO_SURF},
    {gSurfablePokemonShinyPalette_Seel,       PAL_SHINY_TAG_SEEL_SURF},
    {gSurfablePokemonShinyPalette_Dewgong,    PAL_SHINY_TAG_DEWGONG_SURF},
    {gSurfablePokemonShinyPalette_Shellder,   PAL_SHINY_TAG_SHELLDER_SURF},
    {gSurfablePokemonShinyPalette_Cloyster,   PAL_SHINY_TAG_CLOYSTER_SURF},
    {gSurfablePokemonShinyPalette_Krabby,     PAL_SHINY_TAG_KRABBY_SURF},
    {gSurfablePokemonShinyPalette_Kingler,    PAL_SHINY_TAG_KINGLER_SURF},
    {gSurfablePokemonShinyPalette_Lickitung,  PAL_SHINY_TAG_LICKTUNG_SURF},
    {gSurfablePokemonShinyPalette_Rhydon,     PAL_SHINY_TAG_RHYDON_SURF},
    {gSurfablePokemonShinyPalette_Kangaskhan, PAL_SHINY_TAG_KANGASKHAN_SURF},
    {gSurfablePokemonShinyPalette_Horsea,     PAL_SHINY_TAG_HORSEA_SURF},
    {gSurfablePokemonShinyPalette_Seadra,     PAL_SHINY_TAG_SEADRA_SURF},
    {gSurfablePokemonShinyPalette_Goldeen,    PAL_SHINY_TAG_GOLDEEN_SURF},
    {gSurfablePokemonShinyPalette_Seaking,    PAL_SHINY_TAG_SEAKING_SURF},
    {gSurfablePokemonShinyPalette_Staryu,     PAL_SHINY_TAG_STARYU_SURF},
    {gSurfablePokemonShinyPalette_Starmie,    PAL_SHINY_TAG_STARMIE_SURF},
    {gSurfablePokemonShinyPalette_Tauros,     PAL_SHINY_TAG_TAUROS_SURF},
    {gSurfablePokemonShinyPalette_Gyarados,   PAL_SHINY_TAG_GYARADOS_SURF},
    {gSurfablePokemonShinyPalette_Lapras,     PAL_SHINY_TAG_LAPRAS_SURF},
    {gSurfablePokemonShinyPalette_Vaporeon,   PAL_SHINY_TAG_VAPOREON_SURF},
    {gSurfablePokemonShinyPalette_Omanyte,    PAL_SHINY_TAG_OMANYTE_SURF},
    {gSurfablePokemonShinyPalette_Omastar,    PAL_SHINY_TAG_OMASTAR_SURF},
    {gSurfablePokemonShinyPalette_Kabuto,     PAL_SHINY_TAG_KABUTO_SURF},
    {gSurfablePokemonShinyPalette_Kabutops,   PAL_SHINY_TAG_KABUTOPS_SURF},
    {gSurfablePokemonShinyPalette_Snorlax,    PAL_SHINY_TAG_SNORLAX_SURF},
    {gSurfablePokemonShinyPalette_Dratini,    PAL_SHINY_TAG_DRATINI_SURF},
    {gSurfablePokemonShinyPalette_Dragonair,  PAL_SHINY_TAG_DRAGONAIR_SURF},
    {gSurfablePokemonShinyPalette_Dragonite,  PAL_SHINY_TAG_DRAGONITE_SURF},
    {gSurfablePokemonShinyPalette_Mew,        PAL_SHINY_TAG_MEW_SURF},
// Gen II Pokemon
    {gSurfablePokemonShinyPalette_Totodile,   PAL_SHINY_TAG_TOTODILE_SURF},
    {gSurfablePokemonShinyPalette_Croconaw,   PAL_SHINY_TAG_CROCONAW_SURF},
    {gSurfablePokemonShinyPalette_Feraligatr, PAL_SHINY_TAG_FERALIGATR_SURF},
    {gSurfablePokemonShinyPalette_Sentret,    PAL_SHINY_TAG_SENTRET_SURF},
    {gSurfablePokemonShinyPalette_Furret,     PAL_SHINY_TAG_FURRET_SURF},
    {gSurfablePokemonShinyPalette_Chinchou,   PAL_SHINY_TAG_CHINCHOU_SURF},
    {gSurfablePokemonShinyPalette_Lanturn,    PAL_SHINY_TAG_LANTURN_SURF},
    {gSurfablePokemonShinyPalette_Pichu,      PAL_SHINY_TAG_PICHU_SURF},
    {gSurfablePokemonShinyPalette_Marill,     PAL_SHINY_TAG_MARILL_SURF},
    {gSurfablePokemonShinyPalette_Azumarill,  PAL_SHINY_TAG_AZUMARILL_SURF},
    {gSurfablePokemonShinyPalette_Politoed,   PAL_SHINY_TAG_POLITOED_SURF},
    {gSurfablePokemonShinyPalette_Wooper,     PAL_SHINY_TAG_WOOPER_SURF},
    {gSurfablePokemonShinyPalette_Quagsire,   PAL_SHINY_TAG_QUAGSIRE_SURF},
    {gSurfablePokemonShinyPalette_Slowking,   PAL_SHINY_TAG_SLOWKING_SURF},
    {gSurfablePokemonShinyPalette_Qwilfish,   PAL_SHINY_TAG_QWILFISH_SURF},
    {gSurfablePokemonShinyPalette_Sneasel,    PAL_SHINY_TAG_SNEASEL_SURF},
    {gSurfablePokemonShinyPalette_Corsola,    PAL_SHINY_TAG_CORSOLA_SURF},
    {gSurfablePokemonShinyPalette_Remoraid,   PAL_SHINY_TAG_REMORAID_SURF},
    {gSurfablePokemonShinyPalette_Octillery,  PAL_SHINY_TAG_OCTILLERY_SURF},
    {gSurfablePokemonShinyPalette_Mantine,    PAL_SHINY_TAG_MANTINE_SURF},
    {gSurfablePokemonShinyPalette_Kingdra,    PAL_SHINY_TAG_KINGDRA_SURF},
    {gSurfablePokemonShinyPalette_Miltank,    PAL_SHINY_TAG_MILTANK_SURF},
    {gSurfablePokemonShinyPalette_Suicune,    PAL_SHINY_TAG_SUICUNE_SURF},
    {gSurfablePokemonShinyPalette_Tyranitar,  PAL_SHINY_TAG_TYRANITAR_SURF},
    {gSurfablePokemonShinyPalette_Lugia,      PAL_SHINY_TAG_LUGIA_SURF},
// Gen III Pokemon
    {gSurfablePokemonShinyPalette_Mudkip,    PAL_SHINY_TAG_MUDKIP_SURF},
    {gSurfablePokemonShinyPalette_Marshtomp, PAL_SHINY_TAG_MARSHTOMP_SURF},
    {gSurfablePokemonShinyPalette_Swampert,  PAL_SHINY_TAG_SWAMPERT_SURF},
    {gSurfablePokemonShinyPalette_Zigzagoon, PAL_SHINY_TAG_ZIGZAGOON_SURF},
    {gSurfablePokemonShinyPalette_Linoone,   PAL_SHINY_TAG_LINOONE_SURF},
    {gSurfablePokemonShinyPalette_Lotad,     PAL_SHINY_TAG_LOTAD_SURF},
    {gSurfablePokemonShinyPalette_Lombre,    PAL_SHINY_TAG_LOMBRE_SURF},
    {gSurfablePokemonShinyPalette_Ludicolo,  PAL_SHINY_TAG_LUDICOLO_SURF},
    {gSurfablePokemonShinyPalette_Pelipper,  PAL_SHINY_TAG_PELIPPER_SURF},
    {gSurfablePokemonShinyPalette_Exploud,   PAL_SHINY_TAG_EXPLOUD_SURF},
    {gSurfablePokemonShinyPalette_Makuhita,  PAL_SHINY_TAG_MAKUHITA_SURF},
    {gSurfablePokemonShinyPalette_Hariyama,  PAL_SHINY_TAG_HARIYAMA_SURF},
    {gSurfablePokemonShinyPalette_Azurill,   PAL_SHINY_TAG_AZURILL_SURF},
    {gSurfablePokemonShinyPalette_Aggron,    PAL_SHINY_TAG_AGGRON_SURF},
    {gSurfablePokemonShinyPalette_Carvanha,  PAL_SHINY_TAG_CARVANHA_SURF},
    {gSurfablePokemonShinyPalette_Sharpedo,  PAL_SHINY_TAG_SHARPEDO_SURF},
    {gSurfablePokemonShinyPalette_Wailmer,   PAL_SHINY_TAG_WAILMER_SURF},
    {gSurfablePokemonShinyPalette_Wailord,   PAL_SHINY_TAG_WAILORD_SURF},
    {gSurfablePokemonShinyPalette_Barboach,  PAL_SHINY_TAG_BARBOACH_SURF},
    {gSurfablePokemonShinyPalette_Whiscash,  PAL_SHINY_TAG_WHISCASH_SURF},
    {gSurfablePokemonShinyPalette_Corphish,  PAL_SHINY_TAG_CORPHISH_SURF},
    {gSurfablePokemonShinyPalette_Crawdaunt, PAL_SHINY_TAG_CRAWDAUNT_SURF},
    {gSurfablePokemonShinyPalette_Feebas,    PAL_SHINY_TAG_FEEBAS_SURF},
    {gSurfablePokemonShinyPalette_Milotic,   PAL_SHINY_TAG_MILOTIC_SURF},
    {gSurfablePokemonShinyPalette_Spheal,    PAL_SHINY_TAG_SPHEAL_SURF},
    {gSurfablePokemonShinyPalette_Sealeo,    PAL_SHINY_TAG_SEALEO_SURF},
    {gSurfablePokemonShinyPalette_Walrein,   PAL_SHINY_TAG_WALREIN_SURF},
    {gSurfablePokemonShinyPalette_Clamperl,  PAL_SHINY_TAG_CLAMPERL_SURF},
    {gSurfablePokemonShinyPalette_Huntail,   PAL_SHINY_TAG_HUNTAIL_SURF},
    {gSurfablePokemonShinyPalette_Gorebyss,  PAL_SHINY_TAG_GOREBYSS_SURF},
    {gSurfablePokemonShinyPalette_Relicanth, PAL_SHINY_TAG_RELICANTH_SURF},
    {gSurfablePokemonShinyPalette_Luvdisc,   PAL_SHINY_TAG_LUVDISC_SURF},
    {gSurfablePokemonShinyPalette_Latias,    PAL_SHINY_TAG_LATIAS_SURF},
    {gSurfablePokemonShinyPalette_Latios,    PAL_SHINY_TAG_LATIOS_SURF},
    {gSurfablePokemonShinyPalette_Kyogre,    PAL_SHINY_TAG_KYOGRE_SURF},
    {gSurfablePokemonShinyPalette_Rayquaza,  PAL_SHINY_TAG_RAYQUAZA_SURF},
//#ifdef POKEMON_EXPANSION
