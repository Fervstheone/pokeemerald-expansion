const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    [ITEM_HEALTH_BOOSTER] =  {gItemIcon_Mochi, gItemIconPalette_HealthMochi},
    [ITEM_MUSCLE_BOOSTER] =  {gItemIcon_Mochi, gItemIconPalette_MuscleMochi},
    [ITEM_RESIST_BOOSTER] =  {gItemIcon_Mochi, gItemIconPalette_ResistMochi},
    [ITEM_GENIUS_BOOSTER] =  {gItemIcon_Mochi, gItemIconPalette_GeniusMochi},
    [ITEM_CLEVER_BOOSTER] =  {gItemIcon_Mochi, gItemIconPalette_CleverMochi},
    [ITEM_SWIFT_BOOSTER] =  {gItemIcon_Mochi, gItemIconPalette_SwiftMochi},
    [ITEM_HEALTH_SUPRESSOR] =  {gItemIcon_Mochi, gItemIconPalette_HealthMochi},
    [ITEM_MUSCLE_SUPRESSOR] =  {gItemIcon_Mochi, gItemIconPalette_MuscleMochi},
    [ITEM_RESIST_SUPRESSOR] =  {gItemIcon_Mochi, gItemIconPalette_ResistMochi},
    [ITEM_GENIUS_SUPRESSOR] =  {gItemIcon_Mochi, gItemIconPalette_GeniusMochi},
    [ITEM_CLEVER_SUPRESSOR] =  {gItemIcon_Mochi, gItemIconPalette_CleverMochi},
    [ITEM_SWIFT_SUPRESSOR] =  {gItemIcon_Mochi, gItemIconPalette_SwiftMochi},
