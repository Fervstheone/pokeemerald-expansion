...
static const u16 sOptionsLabelGfx_DexNav[]    = {0x000, PALTAG_OPTIONS_CYAN - PALTAG_OPTIONS_START};
static const u16 sOptionsLabelGfx_RegionMap[] = {0x020, PALTAG_OPTIONS_DEFAULT - PALTAG_OPTIONS_START};
...
// For selecting a feature option from a menu, e.g. the Map, Match Call, Beauty search, etc.
static u32 UNUSED LoopedTask_OpenPokenavDexNav(s32 state)
{
    switch (state)
    {
    case 0:
