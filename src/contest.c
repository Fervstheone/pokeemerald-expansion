...
static u16 CalculateContestantRound1Points(u8 who, u8 contestCategory)
{
    ...
    return 2*statMain + (2*statSub1 + 2*statSub2 + gContestMons[who].sheen) / 2;
}
...
static u8 CreateContestantSprite(u16 species, bool8 isShiny, u32 personality, u32 index)
{
    ...
    LoadHueShiftedMonPalette(GetMonSpritePalFromSpeciesAndPersonality(species, isShiny, personality), OBJ_PLTT_ID(2), PLTT_SIZE_4BPP, personality);
